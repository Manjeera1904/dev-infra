...
internal sealed class MessageHeaderV2Writer : IMessageHeaderWriter
{
    public void Write(ServiceBusMessage message, MessageHeader header)
    {
        ...
        message.ApplicationProperties[nameof(MessageHeader.SendingApplicationId)] = header.SendingApplicationId;
        ...
        message.ApplicationProperties[nameof(MessageHeader.MessageVersion)] = "2.0";
    }
}
